...
class tc_calendar{
	...
	function writeDateContainer(){
		...
		//Digitizer
		return "<span id=\"divCalendar_".$this->objname."_lbl\" class=\"searchgroup\"".($this->rtl ? " dir=\"rtl\"" : "")." alt=\"".(($this->year != "undefined") ? $this->getDayName($this->year."-".$this->month."-".$this->day) : "")."\" title=\"".(($this->year != "undefined") ? $this->getDayName($this->year."-".$this->month."-".$this->day) : "")."\">".($this->dig ? $this->digitize_arabics($dd) : $dd)."</span>";
	}
