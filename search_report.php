				...
				<div class='side-content fr'>
					<div class='content-module'>
						<div class='content-module-heading cf'>
							<h3 class='fl'>Search Report </h3>
						</div>
					<div class='content-module-main cf'>
						<table>
						<br>
						<form name='search' method='post' action='search_report.php'>
				...
				else 
				{
					...
					if ($query -> num_rows > 0)
					{
							...
							while($row = $query -> fetch_array()) 
							{
								...
								<td><a href='update_report.php?pid="; echo $row['borrow_name']; echo "'><img class='update' src='dist/img/update.png'></a></td>
								</h3></tr>";
							}
